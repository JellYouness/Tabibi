...
const Medecins = () => {
    ...
    const handleDeleteRow = () => {
        dispatch(deleteMedecin(toBeDeleted.id));
        handleDeleteClose();
    };
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, actions) => {
            ...
            values.id ? dispatch(editMedecin(values)) : dispatch(insertMedecin(values));
            dispatch(fetchMedecins());
            handleClose();
            try {
            } catch (error) {
    ...
    return (
        <MainCard>
            ...
            >
                ...
                >
                    <Box sx={{ p: 1, py: 1.5 }}>
                        <DialogTitle id="alert-dialog-title">Voulez vous supprimez cet Medecin?</DialogTitle>
                        <DialogActions>
                                        ...
                                        <div className="form">
                                            ...
                                            <Stack direction="row" spacing={3} alignItems="center">
                                                ...
                                                <RadioGroup
                                                    ...
                                                    onChange={formik.handleChange}
                                                    onBlur={formik.handleBlur}
                                                    error={formik.touched.civilité && formik.errors.civilité}
                                                    helperText={formik.touched.civilité && formik.errors.civilité}
                                                >
                                            ...
                                            <Select
                                                id="specialite_id"
                                                name="specialite_id"
                                                value={formik.values.specialite_id ? formik.values.specialite_id.toString() : 'disabled'}
                                                onBlur={formik.handleBlur}
                                                onChange={formik.handleChange}
                                                error={formik.touched.specialite_id && formik.errors.specialite_id}
                                                helperText={formik.touched.specialite_id && formik.errors.specialite_id}
                                                inputProps={{ 'aria-label': 'Without label' }}
                                            >
                                                <MenuItem disabled value="disabled">
                                                    <em>Selectionner la specialité</em>
                                                </MenuItem>
